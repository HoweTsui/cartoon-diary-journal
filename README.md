...
- 人物和动物统一采用约 35°–45° 半侧面，必须看见两只同尺寸正圆豆豆眼；禁止正面和单眼正侧面。
- 脸部外轮廓平滑，不出现折点、直角或硬转折。
- 人脸前外侧眼旁从发际/眉线高度到鼻根保留长断口；断口中不画眉毛或鼻梁。
- 人物鼻是上方开口、不填黑的线描半椭圆；动物使用物种正确的单一实心黑鼻，两套鼻型不能互换。
- 身板窄，上臂、前臂、大腿和小腿都极细；手掌略大，鞋子偏大偏扁。动物四肢也保持极细，爪掌略大。
- 动物保留物种结构，但不画写实毛发、阴影或眼睛高光。
- 猫鼻小而黑，位于两眼下方中央；狗鼻为口鼻前端的单个黑色椭圆。
- 不使用彩色毛色块、渐变、灰色阴影、纸张噪点或四格漫画边框。
- 每场必须有 4–10 字短总结；相邻场景至少空出一条笔记本横线高度。气泡只放 1–6 字短反应，整页最多 3 个。
