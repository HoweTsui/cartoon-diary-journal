    ...
    sections = [
        ...
        *(relationship_lines or ["- 本页只出现单人动作，不引入未登记关系"]),
        ...
        (
            ...
            "wobbly line weight and deliberately reduced detail. Use the same 5-6px "
            "black stroke for people, animals, props, furniture, architecture, and "
            "background/environment strokes; pale cyan notebook rules are the only exception. "
            "Never use thin technical, perspective, or gray background lines. Every human keeps "
            ...
            "eye reflections, fur shading, whiskers, or facial hair. A cat has ZERO whisker lines. Expression changes may alter only the low mouth shape and up to two temporary emotion marks; both eyes always remain complete, equal-size, solid-black perfect circles. "
        ...
        (
            ...
            "broken legs, missing trousers, shirts connected directly to legs, realistic pet fur, realistic pet eyes, chibi "
